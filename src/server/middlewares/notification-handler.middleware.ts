...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'allegation.create': {
    roles: ['system-administrator', 'investigator'],
    key: 'new-allegation',
    tenantPath: ['organization', 'user', 'investigator', 'allegation'],
    userPath: [],
  },
  'allegation.update': {
    roles: ['system-administrator', 'investigator'],
    key: 'update-allegation',
    tenantPath: ['organization', 'user', 'investigator', 'allegation'],
    userPath: [],
  },
  'allegation.delete': {
    roles: ['system-administrator', 'investigator'],
    key: 'delete-allegation',
    tenantPath: ['organization', 'user', 'investigator', 'allegation'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['victim', 'investigator', 'system-administrator'];
