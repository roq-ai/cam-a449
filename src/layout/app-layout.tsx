...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['system-administrator', 'victim', 'investigator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Victims', path: '/victims', entity: 'victim', service: AccessServiceEnum.PROJECT, icon: FiAlertTriangle },
