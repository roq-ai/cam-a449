  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Secure, Monitor, Act with cam - Your trusted platform for tracking and routing allegations of abuse in hospitals and NGO social services, ensuring data access only to designated investigators."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Secure, Monitor, Act with cam - Your trusted platform for tracking and routing allegations of abuse in hospitals and NGO social services, ensuring data access only to designated investigators.`}
            </Text>
            <Box
